...
class AppOverview(models.Model):
    ...
    payment_user = models.FloatField(blank=True, null=True)
    ...
    oneday_user_rate = models.FloatField()
...
class BooksAdvgamedetail(models.Model):
    img = models.CharField(max_length=500, blank=True, null=True)
    name = models.CharField(max_length=500)

    class Meta:
        managed = False
        db_table = 'books_advgamedetail'
...
class GamesAppoverview(models.Model):
...
class GamesGamedetail(models.Model):
    ...
    gameplay = models.CharField(max_length=200)
    theme = models.CharField(max_length=200)

    class Meta:
        managed = False
        db_table = 'games_gamedetail'


class GamesPublisher(models.Model):
    name = models.CharField(max_length=30)
    address = models.CharField(max_length=50)
    city = models.CharField(max_length=60)
    state_province = models.CharField(max_length=30)
